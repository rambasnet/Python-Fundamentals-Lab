...
1. Use the partially completed code provided in file_io.py and fix all the FIXMEs. (70 points)
...
6. Push the output files generated by your program to the lab folder. (10 points)
7. Update your README file (10 points) as shown here: [https://github.com/rambasnet/csxxx-rbasnet](https://github.com/rambasnet/csxxx-rbasnet)
