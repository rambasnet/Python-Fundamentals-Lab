...
# FIXME 6: add a new test case  function to test answer function

# FIXME 7: add a new test case function to test answer function
...
# FIXME 8: add a new test case function to test your odd_even function

# FIXME 9: add a new test case function to test your odd_even function
