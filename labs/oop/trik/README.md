# CS0 Lab B - OOP and Unittest Library - Trik Problem

Possible Points: 100

Use the provided partial Python solution to solve the Kattis problem id - trik: [https://open.kattis.com/problems/trik](https://open.kattis.com/problems/trik). Read the problem statement carefully to design a correct solution using OOP and unittest library.
